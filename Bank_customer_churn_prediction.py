...
Original file is located at
    https://colab.research.google.com/drive/1xLAuBUtNd1BM4M5SMHgKXjxMs1eeIDQb
...
def DfPrepPipeline(df_predict,df_train_Cols,minVec,maxVec):
    ...
    continuous_vars = ['CreditScore','Age','Tenure','Balance','NumOfProducts','EstimatedSalary','BalanceSalaryRatio',
                   'TenureByAge','CreditScoreGivenAge']
    cat_vars = ['HasCrCard','IsActiveMember'] # Removed 'Geography', 'Gender'
    ...
    df_predict[continuous_vars] = (df_predict[continuous_vars]-minVec)/(maxVec[continuous_vars]-minVec[continuous_vars]) # Apply scaling only to continuous_vars
